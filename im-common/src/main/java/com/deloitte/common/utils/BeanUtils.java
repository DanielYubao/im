package com.deloitte.common.utils;
...
public class BeanUtils {
     ...
     * @return
     */
    public static boolean fieldEquals(Object oldObj, Object newObj, List<String> ignoreFields) {

        // 获取object的所有属性
        try {
            PropertyDescriptor[] fields = Introspector.getBeanInfo(oldObj.getClass()).getPropertyDescriptors();
